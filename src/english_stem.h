...
public:
  ...
  void operator()(string_typeT &text) final {
    ...
    if (text.length() >= 5 &&
        /*gener*/
        (stem<string_typeT>::is_either(text[0], common_lang_constants::LOWER_G,
                                       common_lang_constants::UPPER_G) &&
         stem<string_typeT>::is_either(text[1], common_lang_constants::LOWER_E,
                                       common_lang_constants::UPPER_E) &&
         stem<string_typeT>::is_either(text[2], common_lang_constants::LOWER_N,
                                       common_lang_constants::UPPER_N) &&
         stem<string_typeT>::is_either(text[3], common_lang_constants::LOWER_E,
                                       common_lang_constants::UPPER_E) &&
         stem<string_typeT>::is_either(text[4], common_lang_constants::LOWER_R,
...
private:
  ...
  bool is_exception(string_typeT &text) const {
    ...
    /*skis*/
    if (text.length() == 4 &&
        stem<string_typeT>::is_either(text[0], common_lang_constants::LOWER_S,
                                      common_lang_constants::UPPER_S) &&
        stem<string_typeT>::is_either(text[1], common_lang_constants::LOWER_K,
                                      common_lang_constants::UPPER_K) &&
        stem<string_typeT>::is_either(text[2], common_lang_constants::LOWER_I,
                                      common_lang_constants::UPPER_I) &&
        stem<string_typeT>::is_either(text[3], common_lang_constants::LOWER_S,
                                      common_lang_constants::UPPER_S)) {
      text = L"ski";
      return true;
    }
    ...
    // exception #1
        ...
        (text.length() == 3 &&
         ...
         stem<string_typeT>::is_either(text[1], common_lang_constants::LOWER_K,
                                       common_lang_constants::UPPER_K) &&
         stem<string_typeT>::is_either(text[2], common_lang_constants::LOWER_Y,
                                       common_lang_constants::UPPER_Y)) ||
        /*news*/
        (text.length() == 4 &&
         ...
         stem<string_typeT>::is_either(text[1], common_lang_constants::LOWER_E,
                                       common_lang_constants::UPPER_E) &&
         stem<string_typeT>::is_either(text[2], common_lang_constants::LOWER_W,
                                       common_lang_constants::UPPER_W) &&
         stem<string_typeT>::is_either(text[3], common_lang_constants::LOWER_S,
                                       common_lang_constants::UPPER_S)) ||
        /*howe*/
        (text.length() == 4 &&
         stem<string_typeT>::is_either(text[0], common_lang_constants::LOWER_H,
        ...
        /*atlas*/
        (text.length() == 5 &&
         stem<string_typeT>::is_either(text[0], common_lang_constants::LOWER_A,
                                       common_lang_constants::UPPER_A) &&
         stem<string_typeT>::is_either(text[1], common_lang_constants::LOWER_T,
                                       common_lang_constants::UPPER_T) &&
         stem<string_typeT>::is_either(text[2], common_lang_constants::LOWER_L,
                                       common_lang_constants::UPPER_L) &&
         stem<string_typeT>::is_either(text[3], common_lang_constants::LOWER_A,
                                       common_lang_constants::UPPER_A) &&
         stem<string_typeT>::is_either(text[4], common_lang_constants::LOWER_S,
                                       common_lang_constants::UPPER_S)) ||
        /*cosmos*/
        (text.length() == 6 &&
         ...
         stem<string_typeT>::is_either(text[1], common_lang_constants::LOWER_O,
                                       common_lang_constants::UPPER_O) &&
         stem<string_typeT>::is_either(text[2], common_lang_constants::LOWER_S,
                                       common_lang_constants::UPPER_S) &&
         stem<string_typeT>::is_either(text[3], common_lang_constants::LOWER_M,
                                       common_lang_constants::UPPER_M) &&
         stem<string_typeT>::is_either(text[4], common_lang_constants::LOWER_O,
                                       common_lang_constants::UPPER_O) &&
         stem<string_typeT>::is_either(text[5], common_lang_constants::LOWER_S,
                                       common_lang_constants::UPPER_S)) ||
        /*bias*/
        (text.length() == 4 &&
         stem<string_typeT>::is_either(text[0], common_lang_constants::LOWER_B,
                                       common_lang_constants::UPPER_B) &&
         stem<string_typeT>::is_either(text[1], common_lang_constants::LOWER_I,
                                       common_lang_constants::UPPER_I) &&
         stem<string_typeT>::is_either(text[2], common_lang_constants::LOWER_A,
                                       common_lang_constants::UPPER_A) &&
         stem<string_typeT>::is_either(text[3], common_lang_constants::LOWER_S,
                                       common_lang_constants::UPPER_S)) ||
        /*andes*/
        (text.length() == 5 &&
         stem<string_typeT>::is_either(text[0], common_lang_constants::LOWER_A,
                                       common_lang_constants::UPPER_A) &&
         stem<string_typeT>::is_either(text[1], common_lang_constants::LOWER_N,
                                       common_lang_constants::UPPER_N) &&
         stem<string_typeT>::is_either(text[2], common_lang_constants::LOWER_D,
                                       common_lang_constants::UPPER_D) &&
         stem<string_typeT>::is_either(text[3], common_lang_constants::LOWER_E,
                                       common_lang_constants::UPPER_E) &&
         stem<string_typeT>::is_either(text[4], common_lang_constants::LOWER_S,
  ...
  bool is_exception_post_step1a(string_typeT &text) const {
    ...
    if (/*inning*/
        (text.length() == 6 &&
         stem<string_typeT>::is_either(text[0], common_lang_constants::LOWER_I,
                                       common_lang_constants::UPPER_I) &&
         stem<string_typeT>::is_either(text[1], common_lang_constants::LOWER_N,
                                       common_lang_constants::UPPER_N) &&
         stem<string_typeT>::is_either(text[2], common_lang_constants::LOWER_N,
                                       common_lang_constants::UPPER_N) &&
         stem<string_typeT>::is_either(text[3], common_lang_constants::LOWER_I,
                                       common_lang_constants::UPPER_I) &&
         stem<string_typeT>::is_either(text[4], common_lang_constants::LOWER_N,
                                       common_lang_constants::UPPER_N) &&
         stem<string_typeT>::is_either(text[5], common_lang_constants::LOWER_G,
                                       common_lang_constants::UPPER_G)) ||
        /*outing*/
        (text.length() == 6 &&
         stem<string_typeT>::is_either(text[0], common_lang_constants::LOWER_O,
                                       common_lang_constants::UPPER_O) &&
         stem<string_typeT>::is_either(text[1], common_lang_constants::LOWER_U,
                                       common_lang_constants::UPPER_U) &&
         stem<string_typeT>::is_either(text[2], common_lang_constants::LOWER_T,
                                       common_lang_constants::UPPER_T) &&
         stem<string_typeT>::is_either(text[3], common_lang_constants::LOWER_I,
                                       common_lang_constants::UPPER_I) &&
         stem<string_typeT>::is_either(text[4], common_lang_constants::LOWER_N,
        ...
        (text.length() == 7 &&
         ...
         stem<string_typeT>::is_either(text[2], common_lang_constants::LOWER_N,
                                       common_lang_constants::UPPER_N) &&
         stem<string_typeT>::is_either(text[3], common_lang_constants::LOWER_N,
                                       common_lang_constants::UPPER_N) &&
         stem<string_typeT>::is_either(text[4], common_lang_constants::LOWER_I,
                                       common_lang_constants::UPPER_I) &&
         stem<string_typeT>::is_either(text[5], common_lang_constants::LOWER_N,
                                       common_lang_constants::UPPER_N) &&
         stem<string_typeT>::is_either(text[6], common_lang_constants::LOWER_G,
                                       common_lang_constants::UPPER_G)) ||
        /*herring*/
        (text.length() == 7 &&
         stem<string_typeT>::is_either(text[0], common_lang_constants::LOWER_H,
         ...
         stem<string_typeT>::is_either(text[2], common_lang_constants::LOWER_R,
                                       common_lang_constants::UPPER_R) &&
         stem<string_typeT>::is_either(text[3], common_lang_constants::LOWER_R,
                                       common_lang_constants::UPPER_R) &&
         stem<string_typeT>::is_either(text[4], common_lang_constants::LOWER_I,
                                       common_lang_constants::UPPER_I) &&
         stem<string_typeT>::is_either(text[5], common_lang_constants::LOWER_N,
        ...
        /*earring*/
        (text.length() == 7 &&
         stem<string_typeT>::is_either(text[0], common_lang_constants::LOWER_E,
                                       common_lang_constants::UPPER_E) &&
         stem<string_typeT>::is_either(text[1], common_lang_constants::LOWER_A,
                                       common_lang_constants::UPPER_A) &&
         stem<string_typeT>::is_either(text[2], common_lang_constants::LOWER_R,
        ...
        (text.length() == 7 &&
         ...
         stem<string_typeT>::is_either(text[1], common_lang_constants::LOWER_R,
                                       common_lang_constants::UPPER_R) &&
         stem<string_typeT>::is_either(text[2], common_lang_constants::LOWER_O,
                                       common_lang_constants::UPPER_O) &&
         stem<string_typeT>::is_either(text[3], common_lang_constants::LOWER_C,
                                       common_lang_constants::UPPER_C) &&
         stem<string_typeT>::is_either(text[4], common_lang_constants::LOWER_E,
                                       common_lang_constants::UPPER_E) &&
         stem<string_typeT>::is_either(text[5], common_lang_constants::LOWER_E,
                                       common_lang_constants::UPPER_E) &&
         stem<string_typeT>::is_either(text[6], common_lang_constants::LOWER_D,
                                       common_lang_constants::UPPER_D)) ||
        /*exceed*/
        (text.length() == 6 &&
         stem<string_typeT>::is_either(text[0], common_lang_constants::LOWER_E,
                                       common_lang_constants::UPPER_E) &&
         stem<string_typeT>::is_either(text[1], common_lang_constants::LOWER_X,
                                       common_lang_constants::UPPER_X) &&
         stem<string_typeT>::is_either(text[2], common_lang_constants::LOWER_C,
                                       common_lang_constants::UPPER_C) &&
         stem<string_typeT>::is_either(text[3], common_lang_constants::LOWER_E,
                                       common_lang_constants::UPPER_E) &&
         stem<string_typeT>::is_either(text[4], common_lang_constants::LOWER_E,
                                       common_lang_constants::UPPER_E) &&
         stem<string_typeT>::is_either(text[5], common_lang_constants::LOWER_D,
                                       common_lang_constants::UPPER_D)) ||
        /*succeed*/
        (text.length() == 7 &&
         stem<string_typeT>::is_either(text[0], common_lang_constants::LOWER_S,
  ...
  void step_1b(string_typeT &text) {
    ...
    if (regress_trim) {
      if (stem<string_typeT>::is_suffix(text,
        ...
        // need to search for r2 again because the 'e' added here may change
        // that
        stem<string_typeT>::find_r2(text, L"aeiouyAEIOUY");
      } else if (
    ...
    if (text.length() >= 1 &&
      ...
      if (stem<string_typeT>::get_r2() != text.length()) {
        ...
        stem<string_typeT>::update_r_sections(text);
                 ...
                 text.length() >= 2 &&
                 // look at the part of the word in front of the last 'e' to see
                 // if it ends with a short syllable.
  ...
  So rap, trap, entrap end with a short syllable, and ow, on, at are classed as
  short syllables. But uproot, bestow, disturb do not end with a short
  syllable.*/
  //---------------------------------------------
...
void stem_word(std::string *word, std::string *stemmed_word) {
  std::wstring w_word(word->begin(), word->end());
  english_stem<std::wstring> Stem;
  Stem(w_word);
  stemmed_word->clear();
  for (int i = 0; i < w_word.size(); i++)
    stemmed_word->push_back(w_word[i]);
}
} // namespace stemming
